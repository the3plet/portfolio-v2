...
const Hero = (props: Props) => {
  return (
    <div className="flex flex-col px-4 gap-20 justify-center  h-full bg-[url('./assets/bg-img.png')] bg-cover bg-center md:pt-20">
      <div className="flex flex-col items-center text-gray-400 text-3xl md:text-6xl font-semibold">
        <p>
        ...
        <h1>
          a{" "}
          <span className="text-white text-3xl md:text-6xl font-extrabold italic">
            Frontend Developer
          </span>
        </h1>
        <h1>
      ...
      <div className="flex justify-center text-center items-center text-gray-400 text-md md:text-2xl font-normal px-12">
        <p>
      ...
      <div className="flex text-white justify-center opacity-70 md:opacity-100 gap-1 items-center mt-10">
        <p className="hover:underline hover:decoration-blue-500 md:text-xl">Scroll to explore more info</p> <ChevronDown className="animate-bounce text-blue-500"/>
      </div>
    </div>
  );
};
